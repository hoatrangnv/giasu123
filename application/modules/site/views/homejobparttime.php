            ...
            <div class="col-md-12"><h1 class="padd-0 mrg-0 text-center font-30">Tìm kiếm việc làm thêm</h1></div>
                <form class="frmparttime">
					<div class="col-md-4 col-sm-4">
									<input class="form-control" id="findparttime" placeholder="Nhập tên công việc muốn tìm" type="text">
					</div>
                    <div class="col-md-2 col-sm-2">
                                    <select id="txtcalamviec" name="txtcalamviec" class="form-control">
                                        <option value="">Chọn ca làm việc</option>
                                        <option value="1">Sáng (từ 8h đến 14h)</option>
                                        <option value="2">Chiều (Từ 14h đến 21h)</option>
                                    </select>
                    </div>
								<div class="col-md-2 col-sm-2">
        ...
        <div class="row">
            ...
            <div class="vl_lc">
                <div class="col-md-12"><div class="tit_hd">
                    ...
                    <a rel="nofollow" href="" class="span_hd">Xem tất cả <img src="images/ic_muiten.png" alt="Việc làm thêm mới nhất"/></a>
                 </div>
                 </div>
                            ...
                            foreach($parttime as $n){ if($i<3){ ?>
                                <div class="itemnews">
                                    <div class="itemnews_l">
                                        ...
                                        <img src="<?= gethumbnail(geturlimagejob($n->usc_create_time).$n->usc_logo,$n->usc_logo,$n->usc_create_time,63,63,100) ?>" onerror='this.onerror=null;this.src="ubuntu/giasu123/images/no-image2.png";' alt="<?php echo $n->new_title?>"/>
                                    <?php }else{ ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tit_hd">
                 ...
                 <a rel="nofollow" href="#" class="span_hd">Xem tất cả <img src="images/ic_muiten.png" alt="Việc làm tiêu biểu"/></a>
                </div>
                <div class="">
                                    ...
                                    <div class="item_hd vip" data-object="<?php echo $n->new_id ?>" data-type="<?php echo $n->new_id ?>">
                                       <div class="company_logo">
                                          <a rel="nofollow" href="<?php echo base_url()."".vn_str_filter($n->new_title)."-job".$n->new_id.".html"; ?>" title="<?php echo $n->new_title ?>">
                                            <?php if(!empty($n->Image)){?>
                                                <img src="<?= gethumbnail(geturlimageAvatar(strtotime($n->usc_create_time)).$n->usc_logo,$n->usc_logo,strtotime($n->usc_create_time),240,175,80) ?>" onerror='this.onerror=null;this.src="ubuntu/giasu123/images/no-image2.png";' alt="<?php echo $n->new_title?>" />
                                            <?php }else{ ?>
                                             <img src="ubuntu/giasu123/images/no-image2.png" alt="no image" onerror='this.onerror=null;this.src="ubuntu/giasu123/images/no-image2.png";' />
                                             <?php } ?>
                                          </a>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tit_hd">
                 ...
                 <a rel="nofollow" href="#" class="span_hd">Xem tất cả <img src="images/ic_muiten.png" alt="Việc làm fulltime mới nhất"/></a>
                </div>
                <div class="">
                    <div class="giasutieubieu row">
                            ...
                            ?><div class="col-md-3 col-sm-12 featureitem">
                                    <div class="item_hd vip" data-object="<?php echo $n->new_id ?>" data-type="<?php echo $n->new_id ?>">
                                       <div class="company_logo">
                                          <a rel="nofollow" href="<?php echo base_url()."".vn_str_filter($n->new_title)."-job".$n->new_id.".html"; ?>" title="<?php echo $n->new_title ?>">
                                            <?php if(!empty($n->Image)){?>
                                                <img src="<?= gethumbnail(geturlimageAvatar(strtotime($n->usc_create_time)).$n->usc_logo,$n->usc_logo,strtotime($n->usc_create_time),240,175,80) ?>" onerror='this.onerror=null;this.src="ubuntu/giasu123/images/no-image2.png";' alt="<?php $n->new_title?>" />
                                            <?php }else{ ?>
                                             <img src="ubuntu/giasu123/images/no-image2.png" alt="no image" onerror='this.onerror=null;this.src="ubuntu/giasu123/images/no-image2.png";' />
                                             <?php } ?>
                                          </a>
