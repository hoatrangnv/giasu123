                            ...
                            ?><div class="col-md-12 col-sm-12 vlthemmoi">
                                    <div class="main_itg">
                                        <div class="itemnews">
                                            ...
                                            <img alt="<?php echo $n->new_title ?>" src="<?= gethumbnail(geturlimageAvatar(strtotime($n->CreateDate)).$n->Image,$n->Image,strtotime($n->CreateDate),63,63,80) ?>" onerror='this.onerror=null;this.src="ubuntu/giasu123/images/no-image2.png";' />
                                        <?php }else{ ?>
                                         <img src="<?= gethumbnail("ubuntu/giasu123/images/no-image2.png","no-image2.png",strtotime($n->usc_create_time),63,40,80) ?>" alt="#" onerror='this.onerror=null;this.src="ubuntu/giasu123/images/no-image2.png";' />
                                         <?php } ?>
                                                </a>                                                
                                    ...
                                    <div class="item_hd vip" data-object="<?php echo $n->new_id ?>" data-type="<?php echo $n->new_id ?>">
                                       <div class="company_logo">
                                          <a href="<?php echo base_url()."".vn_str_filter($n->new_title)."-job".$n->new_id.".html"; ?>" title="<?php echo $n->new_title ?>">
                                            ...
                                            <?php }else{ ?>
                                             <img src="<?= gethumbnail("ubuntu/giasu123/images/no-image2.png","no-image2.png",strtotime($n->usc_create_time),268,171,80) ?>" alt="#" onerror='this.onerror=null;this.src="ubuntu/giasu123/images/no-image2.png";' />
                                             <?php } ?>
                                          </a>
                                       </div>
                                ...
                                <div class="item_hd vip" data-object="<?php echo $n->UserID ?>" data-type="<?php echo $n->UserID ?>">
                                   <div class="company_logo">
                                      <a href="<?php echo base_url()."ung-vien/".vn_str_filter($n->Name).'-uv'.$n->UserID.".html" ?>" title="<?php echo $n->Name ?>">
                                        <?php if(!empty($n->Image)){?>
                                            <img alt="<?php echo $n->new_title ?>" src="<?= gethumbnail(geturlimageAvatar(strtotime($n->CreateDate)).$n->Image,$n->Image,strtotime($n->CreateDate),268,150,80) ?>" onerror='this.onerror=null;this.src="ubuntu/giasu123/images/no-image2.png";' />
                                        <?php }else{ ?>
                                         <img src="<?= gethumbnail("ubuntu/giasu123/images/no-image2.png","no-image2.png",strtotime($n->usc_create_time),268,171,80) ?>" alt="#" onerror='this.onerror=null;this.src="ubuntu/giasu123/images/no-image2.png";' />
                                         <?php } ?>
                                      </a>
